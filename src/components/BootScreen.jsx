...
export default function BootScreen({ onDone, lines = [] }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black text-[#8aff80]">
      <div className="w-[min(92vw,760px)] rounded-lg border border-[#2f2] px-4 py-6 shadow-[0_0_24px_rgba(0,255,128,0.15)]">
